...
const SloganFeatures: React.FC = () => {
    return (
        <div className='bg-featuresBg pt-10 md:pt-[4.75rem] pb-16 px-10 md:px-20 xl:px-48'>
            <div className='flex flex-col items-center md:flex-row space-y-8 md:space-x-8 md:items-start text-center'>
                <div className='flex flex-1 flex-col justify-center items-center'>
                    <img src="/icons/search.svg" alt="" className='mb-8'/>
                    <h1 className='text-lg md:text-xl font-semibold mb-2'>Search</h1>
                ...
                <div className='flex flex-1 flex-col justify-center items-center'>
                    ...
                    <h1 className='text-lg md:text-xl font-semibold mb-2'>Select</h1>
                ...
                <div className='flex flex-1 flex-col justify-center items-center'>
                    ...
                    <h1 className='text-lg md:text-xl font-semibold mb-2'>Stand Out</h1>
